define(['ko', 'model/results', 'js/ajax', 'js/players'], function (ko, results, ajax, players) {
    ...
    var resultViewModel = {
        ...
        show: function (score, elapsedTime) {
            ...
            VK.api('wall.post', { attachments: 'photo-72833562_332914837', message: 'Моя должность в Google: ' + post + '. Заходи, чтобы проверить на какую должность в Google возьмут тебя https://vk.com/app4382885'}, function (answer) {
                self.result(result);
                self.isVisible(true);
            });
        },
