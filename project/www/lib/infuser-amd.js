define(['jquery', 'TrafficCop'], function ($, TrafficCop, window, undefined) {
    /*
     infuser.js
     Author: Jim Cowart
    ...
    var infuser = {
        ...
        defaults: {
            ...
            templateSuffix: ".html",
            templatePrefix: "",
            templatePreProcessor: function (x) {
                return x
            },
            // AJAX Options
            ajax: {
            ...
            postRender: function (targetElement) {
            }, // NO_OP effectively by default
            preRender: function (targetElement, template) {
            }, // NO_OP effectively by default
        ...
        getSync: function (options) {
            ...
            if (!template || $.inArray(templateOptions.ajax.url, errors) !== -1) {
                templateHtml = null;
                templateOptions.ajax.success = function (response) {
